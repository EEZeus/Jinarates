...
import './StudentProfilePageHeader.css'
            ...
            <div class="container text-left mx-0 px-0 text-white w-100 ">
                <div class="row ">
                    ...
                    <div class="col mt-4 pl-0">
                        ...
                        University:<span className='fs-6 text-dark'>Something</span></h5>
                        <h5 className='mt-4 ml-0 pl-0'>Major: <span className='fs-6 text-dark'>Something</span></h5>
                    </div>
